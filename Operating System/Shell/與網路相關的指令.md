...
上方範例是上傳 local 的 img1.png, img2.png, …, img1000.png 等 1000 個檔案到 `ftp.example.com` 這台 server，使用 protocol 的是 [[檔案傳輸#FTP|FTP]]。
...
- `+short` option 可以讓輸出更為簡潔（只保留 IP address 的部分）
