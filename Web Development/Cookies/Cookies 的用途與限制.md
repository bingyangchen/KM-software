...
關於使用 Session ID 實現身份驗證的更多資訊，詳見 [Cookie/Session Authentication](</Web Development/Authentication - Cookie-Based vs. Token-Based.md#Cookie-Based Authentication>)。
